...
class JoinToBasketBallGUI:
    def __init__(self):
        ...
        self.db_unit.create_table("./Join_to_a_basketball_team/player.db")
        
        self.predict = PredictToJoin()
    ...
    def get_all_datas_from_player(self):
        ...
        if self.check_input_is_correct() == True: 
            ...
            self.db_unit.insert_to_table("./Join_to_a_basketball_team/player.db", self.player_datas)
            self.db_unit.select_all_data("./Join_to_a_basketball_team/player.db")
    ...
    def predict_applicant_what_could_be(self):
        ...
        X, y_member, y_center = self.predict.preparing_the_dataframe_to_predict()
